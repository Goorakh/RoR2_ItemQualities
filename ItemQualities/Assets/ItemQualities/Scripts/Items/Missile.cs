...
namespace ItemQualities.Items
{
    static class Missile
    {
        ...
        static IEnumerator LoadContent(ContentIntializerArgs args)
        {
            ...
            AsyncOperationHandle<GameObject> explodeEffectLoad = AddressableUtil.LoadTempAssetAsync<GameObject>(RoR2_Base_StickyBomb.BehemothVFX_prefab);
        ...
        static void GlobalEventManager_ProcessHitEnemy(ILContext il)
        {
            ...
            static bool checkShouldFireBigMissile(DamageInfo damageInfo)
            {
                ...
                ItemQualityCounts missile = default;
                if (attackerInventory)
                {
                    missile = ItemQualitiesContent.ItemQualityGroups.Missile.GetItemCounts(attackerInventory);
                }
