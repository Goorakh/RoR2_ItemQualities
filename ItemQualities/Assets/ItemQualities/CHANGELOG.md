...
* Reworks (Click to reveal):
    ...
    * <details><summary>Safer Spaces</summary> Chance on block to apply a fog to all nearby enemies that increases damage taken from all void-based attacks.</details>
